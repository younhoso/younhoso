...
<td style=\"border:1px solid #c4c4c4; width:537px;\">
    ...
    <td>
        <table cellpadding=\"0\" cellspacing=\"0\" border=\"0\">
        <tr>
        <td style=\"color:#494949; font-size:15px; font-weight:bold; padding:50px 20px 20px 20px;\">가입완료안내.</td>
        </tr>
        <tr>
        <td style=\"padding:20px 40px 10px 40px; border-top:2px solid #454545; color:#494949; font-size:12px;\">아이러브아프리카에 가입해 주셔서 감사합니다.</td>
        </tr>
        <tr>
...
$_mail_title = "[I LOVE AFRICA] {{USER_NAME}} 님! 회원가입을 축하합니다.";
