...
?>
                                ...
                                <tr>
                                    <td style="width:160px; height:60px; border-bottom:1px solid #dedede; background:#f0f0f0; font-size:12px; color:#494949; font-weight:bold; text-align:center;" rowspan="3">주소</td>
                                ...
                                <tr>
                                    <td style="width:552px; height:30px; border-bottom:1px solid #dedede; font-size:12px; color:#494949; padding-left:20px;"><input type="text" style="width:500px; height:18px; border:1px solid #cacaca;" name="user_add2" /></td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:552px; height:30px; border-bottom:2px solid #454545; font-size:12px; color:#494949; padding-left:20px;"><select style="width:150px; height:20px; border:1px solid #cacaca;" name="user_job">
                                            <option value="">선택하세요.</option>
                                            <?
			foreach($_CODE[7] as $key => $value){
				$_selected=($key == $_row['user_job']) ? " selected" : "";
		?>
                                            <option value="<?=$key?>"<?=$_selected?>>
                                            <?=$value?>
                                            </option>
                                            <?}?>
                                        </select></td>
                    ...
                    <tr>
                        <td align="center" style="padding:30px 0;"><span style="padding-right:7px;">
                            <input type="image" src="img/sub09/s94211_bt1.png" />
                            </span><span style="padding-left:7px;"><a href="/"><img src="img/sub09/s94211_bt2.png" /></a></span></td>
                    </tr>
                </table></td>
        </tr>
    </table>
