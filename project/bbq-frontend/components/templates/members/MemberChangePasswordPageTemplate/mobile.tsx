...
import { MemberChangePasswordPageTemplateComponentProps } from './MemberChangePasswordPageTemplate';

export const MemberChangePasswordPageTemplateMobile: FC<
  MemberChangePasswordPageTemplateComponentProps
> = ({
  token,
  integration,
  name,
