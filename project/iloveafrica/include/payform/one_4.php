...
<table width="658" border="0" cellpadding="0" cellspacing="0" style="color:#494949; margin:30px 21px;">
    <tr>
    <td width="638" height="162" style="background:url(./img/m02/s02/s214.jpg) no-repeat; color:#494949; font-size:12px; padding-bottom:15px;" valign="bottom" align="right" />※ 아래 항목을 적어주세요. 담당자가 연락을 드립니다.</td>
    </tr>
    <tr>
    <td>
  ...
  <tr>
	<td><input type="radio" name="wl_give_type" value="1" onclick="one_wedding_field(1);" class="{label:'후원종류',groupcheck:true}"></td>
    <td class="p1">결혼축하</td>
	<td><input type="radio" name="wl_give_type" value="2" onclick="one_wedding_field(2);" class="{label:'후원종류',groupcheck:true}"></td>
    <td class="p1">결혼기념</td>
  </tr>
</table>
    ...
    <tr>
    <td width="25" height="30" align="center"><img src="./img/m02/s02/img.jpg" /></td>
    <td width="98" height="30" class="title1">대상</td>
    <td width="535" height="30">
    <table cellpadding="0" cellspacing="0" border="0" class="title2">
  <tr>
    <td><input type="checkbox" name="wl_give_target" id="wl_give_target_me" value="me" disabled></td>
    <td class="p1">본인</td>
    <td class="p1">신랑성명</td>
	<td><input type="text" name="wl_give_man" id="wl_give_target_man" value="<?=($_row["wl_give_type"]=="me") ? "" : $_row["wl_give_man"]?>" style="width:70px;" disabled></td>
	<td class="p1">신부성명</td>
	<td><input type="text" name="wl_give_woman" id="wl_give_target_woman" value="<?=($_row["wl_give_type"]=="me") ? "" : $_row["wl_give_woman"]?>" style="width:70px;" disabled></td>
  </tr>
</table>
