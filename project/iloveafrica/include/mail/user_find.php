...
<td style=\"border:1px solid #c4c4c4; width:537px;\">
    ...
    <td>
        <table cellpadding=\"0\" cellspacing=\"0\" border=\"0\">
        <tr>
        <td style=\"color:#494949; font-size:15px; font-weight:bold; padding:50px 20px 20px 20px;\">아이디 찾기</td>
        </tr>
        <tr>
        <td style=\"padding:20px 40px 10px 40px; border-top:2px solid #454545; color:#494949; font-size:12px;\">회원님께서 요청하신 아이디 안내입니다.</td>
        </tr>
        <tr>
        ...
        <tr>
        <td style=\"width:137px; border-right:1px solid #dedede; color:#494949; font-size:12px; font-weight:bold; padding-left:20px;\">이메일</td>
        <td style=\"width:280px; color:#676767; font-size:11px; padding:10px 0 10px 20px;\">{{USER_MAIL}}</td>
        </tr>
        </table>
        </td>
        </tr>
...
$_mail_title = "[I LOVE AFRICA] {{USER_NAME}} 님께서 요청하신 아이디 안내입니다.";
