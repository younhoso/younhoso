...
interface ContentAppBoardNoticeWriteCondition {
  title: string;
  content: string;
  file: IFileTypes[];
}
...
export default function ContentAppBoardNoticeWrite() {
  const [selectedValue, setSelectedValue] = useState<ContentAppBoardNoticeWriteCondition>({
    title: '',
    content: '',
    file: [],
  });
  const handleValueChange = (key: keyof ContentAppBoardNoticeWriteCondition, value: any) => {
