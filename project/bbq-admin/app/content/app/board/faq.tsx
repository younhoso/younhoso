...
interface ContentAppBoardFaqListCondition {
  faqType: string;
  perPage: string;
}

export default function ContentAppBoardFaqList() {
  const [selectedValue, setSelectedValue] = useState<ContentAppBoardFaqListCondition>({
    faqType: 'all',
    perPage: '20',
  });
  const handleValueChange = (key: keyof ContentAppBoardFaqListCondition, value: any) => {
