...
import { MemberFindUsernameSuccessPageTemplateComponentProps } from './MemberFindUsernameSuccessPageTemplate';

export const MemberFindUsernameSuccessPageTemplateMobile: FC<
  MemberFindUsernameSuccessPageTemplateComponentProps
> = ({
  username,
