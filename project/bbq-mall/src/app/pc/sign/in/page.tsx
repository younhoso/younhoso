...
import { PcSignInPageStyled } from '@/styles/pageStyled/pc/pcSignInPageStyled';
import {
  getLocalStorageItem,
...
const PcSignIn = () => {
  ...
  return (
    <PcSignInPageStyled>
      ...
      <p className="sns-label">SNS 계정으로 로그인하기</p>
      ...
      <Button className="guest-order-check" onClick={() => router.push('/order/check/guest')}>
        비회원 주문조회
      </Button>
    </PcSignInPageStyled>
  );
