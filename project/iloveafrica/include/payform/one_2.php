...
<table width="658" border="0" cellpadding="0" cellspacing="0" style="color:#494949; margin:30px 21px;">
    <tr>
    <td><img src="./img/m02/s02/s212.jpg" /></td>
    </tr>
    <tr>
    <td>
  ...
  <tr>
    <td><input type="radio" name="bl_give_type" value="1" onclick="one_birth_field(1);" class="{label:'후원종류',groupcheck:true}" <?if($_row["bl_give_type"]=="1"){?> checked<?}?>></td>
    <td class="p1">생일</td>
    <td><input type="checkbox" name="bl_give_birth" id="bl_give_birth_me" value="me" onclick="one_birth_field(1);"<?if($_row["bl_give_birth"]!="me" || $_row["bl_give_birth"]==""){?> disabled<?}?><?if($_row["bl_give_birth"]=="me"){?> checked<?}?>></td>
    <td class="p1">본인</td>
    <td class="p1">선물받으실 분</td>
    <td><input type="text" name="bl_give_birth" id="bl_give_birth_name" style="width:100px;" value="<?=($_row["bl_give_birth"]=="me") ? "" : $_row["bl_give_birth"]?>"<?if($_row["bl_give_birth"]=="me" || $_row["bl_give_birth"]==""){?> disabled <?}?>></td>
  </tr>
</table>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="title2">
  <tr>
    <td><input type="radio" name="bl_give_type" value="2" onclick="one_birth_field(2);" class="{label:'후원종류',groupcheck:true}" <?if($_row["bl_give_type"]=="2"){?> checked<?}?>></td>
    <td class="p1">돌잔치</td>
    <td class="p1">아기이름</td>
    <td><input type="text" name="bl_give_baby" id="bl_give_baby" style="width:100px;" value="<?=$_row["bl_give_baby"]?>"<?if($_row["bl_give_type"]=="1" || $_row["bl_give_type"]==""){?> disabled <?}?>></td>
    <td class="p1">부모님이름</td>
    <td><input type="text" name="bl_give_parent" id="bl_give_parent" style="width:100px;" value="<?=$_row["bl_give_parent"]?>"<?if($_row["bl_give_type"]=="1" || $_row["bl_give_type"]==""){?>  disabled <?}?>></td>
  </tr>
</table>
