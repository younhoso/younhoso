<?
	//기업
	$user_person1 = substr($argu["c_person_chk"], 0, 3);
	$user_person2 = substr($argu["c_person_chk"], 3, 2);
	$user_person3 = substr($argu["c_person_chk"], -5);
?>
...
<input type="hidden" name="user_name" id="user_name" value="<?=$_row["user_name"]?>">
<input type="hidden" name="user_type" id="user_type" value="<?=$_row["user_type"]?>">
<input type="hidden" name="user_person1" id="user_person1" value="<?=$_row["user_person1"]?>">
<input type="hidden" name="user_person2" id="user_person2" value="<?=$_row["user_person2"]?>">
        ...
        <td class="sub_c" valign="top"><table cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td><table cellpadding="0" cellspacing="0" border="0" width="732">
                            ...
                            <tr>
                                <td style="width:160px; height:30px; border-bottom:1px solid #dedede; border-top:2px solid #454545; background:#f0f0f0; font-size:12px; color:#494949; font-weight:bold; text-align:center;">회사명</td>
                            ...
                            <tr>
                                <td style="width:160px; height:30px; border-bottom:1px solid #dedede; background:#f0f0f0; font-size:12px; color:#494949; font-weight:bold; text-align:center;">사업자등록번호</td>
                                <td style="width:552px; height:30px; border-bottom:1px solid #dedede; font-size:12px; color:#a0a0a0; padding-left:20px;"><?=$user_person1?>-<?=$user_person2?>-<?=$user_person3?></td>
                            </tr>
                            <tr>
                                ...
                                <td style="width:552px; height:30px; border-bottom:1px solid #dedede; font-size:12px; color:#a0a0a0; padding-left:20px;"><ul>
                            ...
                            <tr>
                                ...
                                <td style="width:552px; height:30px; border-bottom:1px solid #dedede; font-size:12px; color:#a0a0a0; padding-left:20px;"><input type="password" style="width:150px; height:18px; border:1px solid #cacaca;" name="user_pwd" class="{label:'비밀번호',required:true}" maxlength="16"/>
                            ...
                            <tr>
                                ...
                                <td style="width:552px; height:30px; border-bottom:1px solid #dedede; font-size:12px; color:#a0a0a0; padding-left:20px;"><input type="password" style="width:150px; height:18px; border:1px solid #cacaca;" class="{label:'비밀번호확인',required:true,equal:'user_pwd'}"/>
                                    비밀번호 오타확인입니다.</td>
                            </tr>
                            <tr>
                                <td style="width:160px; height:30px; border-bottom:1px solid #dedede; background:#f0f0f0; font-size:12px; color:#494949; font-weight:bold; text-align:center;">담당자 성명</td>
                                <td style="width:552px; height:30px; border-bottom:1px solid #dedede; font-size:12px; color:#494949; padding-left:20px;"><input type="text" style="width:150px; height:18px; border:1px solid #cacaca;" name="user_man" class="{label:'담당자성명',required:true}" /></td>
                            </tr>
                            <tr>
                ...
                <tr>
                    <td><table cellpadding="0" cellspacing="0" border="0" width="732">
                            ...
                            <tr>
                                <td style="width:160px; height:30px; border-top:2px solid #454545; border-bottom:1px solid #dedede; background:#f0f0f0; font-size:12px; color:#494949; font-weight:bold; text-align:center;">추천인</td>
                                <td style="width:552px; height:30px; border-top:2px solid #454545; border-bottom:1px solid #dedede; font-size:11px; color:#a0a0a0; padding-left:20px;"><input type="text" style="width:150px; height:18px; border:1px solid #cacaca;" name="vote_id"/>
                                    소개해주신 분의 아이디를 적어주세요.</td>
                            </tr>
                            <tr>
                                <td style="width:160px; height:30px; border-bottom:1px solid #dedede; background:#f0f0f0; font-size:12px; color:#494949; font-weight:bold; text-align:center;">직원 수</td>
