...
export const modal = {
    ...
    init() {
        ...
        PT_STATE.$PROJECT.off('.click.clickModal').on('click.clickModal', '[data-role="btnModal"]', function (e) {
            ...
            //     !_.isMobile() ? 
            //         $target.css('top', winTop + (winHeight - targetHeight) - headerHeight - tabHeight) : 
            //         $target.css('top', winTop + (winHeight - targetHeight) / 2 - headerHeight - tabHeight) : 
            //     $target.css('top', winTop);
