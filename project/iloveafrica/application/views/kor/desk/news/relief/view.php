<div id="container">
    ...
    <div class="sub_cont">
        ...
        <?php include APPPATH."views/$nation/desk/news/sub_relief_tab.php"; ?>
        <div class="sub_cont_s">
            ...
            <div class="m_ila_board">
                ...
                <div class="view_write">
                    ...
                    <div class="w"><strong>· 조회수</strong><span class="bar">|</span><?php echo $result->am_hit ?></div>
                </div>
                <div class="view_cont" style="text-align:left;">
                    <?php
                        echo $result->am_content; 
                    ?>
                </div>
                <div class="view_page">
