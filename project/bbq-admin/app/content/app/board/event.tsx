...
interface ContentAppBoardEventListCondition {
  filter: string;
  perPage: string;
  checkList: string[];
}

export default function ContentAppBoardEventList() {
  const [selectedValue, setSelectedValue] = useState<ContentAppBoardEventListCondition>({
    filter: 'all',
    perPage: '20',
    checkList: [],
  });
  const handleValueChange = (key: keyof ContentAppBoardEventListCondition, value: any) => {
