<div id="container">
    ...
    <div class="sub_cont">
        ...
        <div class="sub_cont_s">
            <div style="position: static; width: 220px; height: 21px; display: block; vertical-align: baseline; float: left;"><div class="m_left is_stuck" style="position: fixed; top: 30px; width: 220px;">
                <h3>공지사항</h3>
            </div></div>
