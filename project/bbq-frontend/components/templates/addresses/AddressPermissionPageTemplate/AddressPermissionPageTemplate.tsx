...
import { AddressPermissionPageTemplateMobile } from './mobile';

export interface AddressPermissionPageTemplateProps {}

export interface AddressPermissionPageTemplateComponentProps
  extends AddressPermissionPageTemplateProps {}

export const AddressPermissionPageTemplate: FC<AddressPermissionPageTemplateComponentProps> & {
  Mobile: FC<AddressPermissionPageTemplateComponentProps>;
} = ({ ...rest }) => {
...
AddressPermissionPageTemplate.Mobile = AddressPermissionPageTemplateMobile;
