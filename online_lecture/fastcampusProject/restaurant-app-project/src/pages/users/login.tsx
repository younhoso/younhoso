...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col justify-center items-center px-6 lg:px-8 h-[60vh]">
      <div className="mx-auth w-full max-w-sm">
        <div className="text-blue-800 text-center text-2xl font-semibold italic">Login Page</div>
