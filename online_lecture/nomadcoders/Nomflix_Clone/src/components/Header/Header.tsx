...
import { Circle, HeaderStyled, Item, Items, Logo, Nav, logoVariants, navVariants } from './styled';
      ...
      <Wrapper>
        <div className="inner">
          <Nav variants={navVariants} animate={navAnimation} initial={'top'}>
            ...
            <Items className="category-inner">
              <Item>
                <Link href="/">Home {pathname === '/' && <Circle layoutId="circle" />}</Link>
              </Item>
              <Item>
                <Link href="/tv">
