...
export interface RelayEditPageTemplate {
  values: InputValues;
  setValues: (values: InputValues) => void;
  selectedFiles: (File | string | null | undefined)[];
  handleFileChange: ({ file, index }: { file?: any; index: number }) => void;
  handleSubmitButtonClick: () => void;
  submitButtonEnabled: boolean;
}

export const RelayEditPageTemplate: FC<RelayEditPageTemplate> = ({
  values,
  setValues,
  selectedFiles,
  handleFileChange,
                        ...
                        <Input
                          ...
                          value={
                            selectedFiles[index] instanceof File
                              ? (selectedFiles[index] as File)?.name
                              : (selectedFiles[index] as string)
                                ? (selectedFiles[index] as string).split('/').slice(-1)[0]
                                : ''
                          }
                          onChange={e => {}}
                        />
