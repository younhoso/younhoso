...
import { WithdrawClaimProps } from '../pc/WithdrawClaim';
import { WithdrawClaimMobileStyled } from './styled';

const WithdrawClaimMobile = ({
  className,
  resetClaimType,
  refetch,
  activeOrderOption,
  ...
  return (
    <WithdrawClaimMobileStyled
      className={clsx('WithdrawClaimMobile', className)}
    ></WithdrawClaimMobileStyled>
  );
};

export default WithdrawClaimMobile;
