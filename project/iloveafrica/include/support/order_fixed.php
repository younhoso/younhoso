...
<input type="hidden" name="f_no" value="<?=$_si_nos?>" />
<input type="hidden" name="good_name" value="[정기후원]<?=$_si_names?>" />
...
?>
                    <li class="fl">
                      <input type="radio" name="pay_method" value="<?=$key?>" <?=$_checked?> onclick="pay_method_form('fix_form.php', '<?=$key?>', '<?=$value?>');" />
                    </li>
...
?>
        ...
        <tr>
          <td style="padding:60px 0 13px 0;"><img src="img/sub03/title2.png" /> <span class="fr">
            <ul>
              <li class="fl">
                <input type="checkbox" id="same_data" onclick="fix_same_data();" value="1" <?if($argu['same_data']=='1'){?> checked<?}?>/>
              </li>
        ...
        <tr>
          <td><table cellpadding="0" cellspacing="0" border="0" style="width:731px;">
              <tr>
				...
				<input type="text" style="height:18px; width:150px; border:1px solid #cacaca;" name="fl_give_name" maxlength='20' class="{label:'성명',required:true}"/></td>
              </tr>
              <tr>
                ...
                <td style="width:621px; padding-left:20px; height:30px; font-size:12px; color:#494949; border-bottom:1px solid #dedede;">
					<input type="text" style="height:18px; width:100px; border:1px solid #cacaca;ime-mode:disabled;" name="fl_give_person1" maxlength='6' class="{label:'주민번호',required:true}" onkeypress="numberOnly()"/>
                  -
                  <input type="password" style="height:18px; width:100px; border:1px solid #cacaca;ime-mode:disabled;" name="fl_give_person2" maxlength='7' class="{label:'주민번호',required:true}" onkeypress="numberOnly()"/>
              ...
              <tr>
                ...
                <td style="width:621px; padding-left:20px; height:30px; font-size:12px; color:#494949; border-bottom:1px solid #dedede;">
				<select style="width:60px; height:20px; border:1px solid #cacaca;" name="fl_give_tel1" class="{label:'연락처',required:true}">
                  ...
                  -
                  <input type="text" style="height:18px; width:100px; border:1px solid #cacaca;ime-mode:disabled;" name="fl_give_tel2" maxlength='4' class="{label:'연락처',required:true}" onkeypress="numberOnly()" value="<?=$argu['so_give_tel2']?>"/>
                  -
                  <input type="text" style="height:18px; width:100px; border:1px solid #cacaca;ime-mode:disabled;" name="fl_give_tel3" maxlength='4' class="{label:'연락처',required:true}" onkeypress="numberOnly()" value="<?=$argu['so_give_tel3']?>"/></td>
              </tr>
              <tr>
                ...
                <td style="width:621px; padding-left:20px; height:30px; font-size:12px; color:#494949; border-bottom:1px solid #dedede;">
				<input type="text" style="height:18px; width:150px; border:1px solid #cacaca;ime-mode:disabled;" name="fl_give_email1" class="{label:'이메일',required:true}" value="<?=$argu['so_give_email1']?>"/>
                  @
                  <input type="text" style="height:18px; width:150px; border:1px solid #cacaca;ime-mode:disabled;" name="fl_give_email2" id="fl_give_email2" readonly class="{label:'이메일',required:true}" value="<?=$argu['so_give_email2']?>"/>
                  <select style="width:100px; height:20px; border:1px solid #cacaca; margin-left:5px;" name="fl_give_email3" onchange="selectEmail(this.value, '#fl_give_email2');">
              ...
              <tr>
                ...
                <td style="width:621px; padding-left:20px; height:30px; font-size:12px; color:#494949; border-bottom:1px solid #dedede;"><ul>
                    <li class="fl" style="line-height:20px;">
                      <input type="text" style="width:100px; height:18px; border:1px solid #cacaca;" name="fl_give_zip" readonly onclick="zipcode('fixedFrm', 'fl_give_zip', 'fl_give_add1', 'fl_give_add2');" class="{label:'우편번호',required:true}" value="<?=$argu['so_give_zip']?>"/>
                    </li>
                    <li class="fl" style="padding-left:5px; line-height:20px; padding-top:2px;"><img src="img/sub03/woo.png" class="cp" onclick="zipcode('fixedFrm', 'fl_give_zip', 'fl_give_add1', 'fl_give_add2');"/></li>
					<li>
<?
...
?>
                    <li class="fl">
                      <input type="radio" name="fl_give_local" value="<?=$key?>" <?=$_checked?> class="{label:'주소지',groupcheck:true}" />
                    </li>
                    <li class="fl" style="padding:5px 15px 0 5px;"><?=$value?></li>
<?
	}
?>
              ...
              <tr>
                <td style="width:621px; padding-left:20px; height:30px; font-size:12px; color:#494949; border-bottom:1px solid #dedede;">
				<input type="text" style="height:18px; width:600px; border:1px solid #cacaca;" name="fl_give_add1" style="width:345px;" readonly class="{label:'주소',required:true}" value="<?=$argu['fl_give_add1']?>"/></td>
              </tr>
              <tr>
                <td style="width:621px; padding-left:20px; height:30px; font-size:12px; color:#494949; border-bottom:2px solid #454545;">
				<input type="text" style="height:18px; width:600px; border:1px solid #cacaca;" name="fl_give_add2" style="width:345px;" class="{label:'상세주소',required:true}" value="<?=$argu['fl_give_add2']?>"/></td>
              </tr>
            </table>
