        ...
        let options = {
            ...
            on: {
                ...
                slideChange: function(){
                    ...
                    // const slideDiscCom = document.querySelector('#sec_buying_com .pt_slide__subtxt');
                    // const slideDiscSys = document.querySelector('#sec_buying_sys .pt_slide__subtxt');
                    // this.realIndex === 0 ? 
                    //     slideDiscCom.classList.add('hide-txt') : slideDiscCom.classList.remove('hide-txt');
                    // this.realIndex === 0 ? 
                    //     slideDiscSys.classList.add('hide-txt') : slideDiscSys.classList.remove('hide-txt');
                },
                breakpoint: function () {
                    var _self = this;
                    setTimeout(function () {
    ...
    update(slideId, isOnce, useTab) {
        ...
        function mainSlide(){
            ...
            $.each(arrImg, function(idx){
                ...
                const imgSize = checkDevice() == 'pc' ? '?$784_512_PNG$' : '?$720_452_PNG$';
