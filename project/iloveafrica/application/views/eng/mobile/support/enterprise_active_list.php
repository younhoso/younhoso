<div class="tab_d2">
    <ul id="t2">
        <li><a href="s4_1.html">정기후원</a></li>
        <li><a href="s4_2.html">일시후원</a></li>
        <li><a href="s4_3.html">기념일기부</a></li>
        <li><a href="s4_4.html">유산기부</a></li>
        <li><a href="s4_5.html">단체기부</a></li>
        <li class="on"><a href="s4_6.html">기업후원</a></li>
    </ul>
</div>
<div class="sub_cont_c">
    ...
    <div class="tab_d3">
        <ul id="t3">
            ...
            <li><a href="#ta3">활동보기</a></li>
        </ul>
    </div>

    <div class="top_img">
        <ul class="top_slider">
            <li><img src="/assets/images/mobile/slide/sup18_01_01.jpg" alt=""></li>
            <li><img src="/assets/images/mobile/slide/sup18_01_02.jpg" alt=""></li>
            <li><img src="/assets/images/mobile/slide/sup18_01_03.jpg" alt=""></li>
            <li><img src="/assets/images/mobile/slide/sup18_01_04.jpg" alt=""></li>
            <li><img src="/assets/images/mobile/slide/sup18_01_05.jpg" alt=""></li>
            <li><img src="/assets/images/mobile/slide/sup18_01_06.jpg" alt=""></li>
            <li><img src="/assets/images/mobile/slide/sup18_01_07.jpg" alt=""></li>
            <li><img src="/assets/images/mobile/slide/sup18_01_08.jpg" alt=""></li>
            <li><img src="/assets/images/mobile/slide/sup18_01_09.jpg" alt=""></li>
            <li><img src="/assets/images/mobile/slide/sup18_01_10.jpg" alt=""></li>
            <li><img src="/assets/images/mobile/slide/sup18_01_11.jpg" alt=""></li>
        </ul>
    </div>
    ...
    <div class="m_cont" id="ta1">
        <div class="m_txt">
            <p>
                <strong>아이러브아프리카는 기업이 고정관념의 틀에서 깨어난 진정한 가치를 창출하는 지속가능한 사회공헌을 추구할 수 있도록 파트너가 되어 드리겠습니다.</strong>
            </p>
            
        </div>
        <ul class="m_biz_info">
            <li><span>MOU 파트너십 협력사업</span></li>
            <li><span>기업의 요청 맞춤공헌사업</span></li>
            <li><span>아프리카 및 국내<br />단기공헌사업</span></li>
            <li><span>아프리카 및 국내<br />장기공헌사업</span></li>
            <li><span>기업의 생산물품 기부사업<br />(콘테이너 한 개기준 운송)</span></li>
            <li><span>이벤트. 캠페인. <br />스팟. 공헌사업</span></li>
        </ul>
        <div class="m_ngo">
            <div class="tit">NGO아이러브아프리카의 강점</div>
            <div class="ol_lst">
                <ol>
                    <li><strong>1</strong> 아프리카대륙을 대상으로 전문적으로 돕는 국제구호개발 NGO입니다.</li>
                    <li><strong>2</strong> 현지정부기관과 연계 신뢰를 구축하고 구제사업을 명품으로 완성하는 NGO입니다.</li>
                    <li><strong>3</strong> 세계 3대 슬럼가인 케냐 키베라 슬럼가에 들어가 구제사업 하는 유일한 NGO입니다.</li>
                    <li><strong>4</strong> 아프리카대륙 54개국과 구제 사업 구축에 있어 소통과 협력이 가능한 NGO입니다.</li>
                    <li><strong>5</strong> 기업의 아프리카공헌에 있어서 신뢰와 믿음으로 책임을 다하는 아프리카전문NGO입니다.</li>
                </ol>
            </div>
        </div>
        
        <div class="m_ngo_benefit">
            <div class="tit">아프리카공헌사업 기업이 얻게 되는 강점</div>
            <ul>
                <li>
                    <div class="ic1"></div>
                    <p>먼저 <span>GIVE!</span>아프리카에 베풀어주고<br /><span>and TAKE!</span> 국내에서 반사이익을 획득합니다</p>
                </li>
                <li>
                    <div class="ic2"></div>
                    <p>CSR기업으로서 국내 혹은<br />아프리카시장에서 이익을 취합니다</p>
                </li>
                <li>
                    <div class="ic3"></div>
                    <p>B2C기업이라면 국내시장과 아프리카시장의<br />전략적 홍보마케팅에 기여합니다</p>
                </li>
                <li>
                    <div class="ic4"></div>
                    <p>B2C기업이라면 TV방송 미디어매체,<br />전략적 소셜마케팅을 활용, 매출에 기여합니다</p>
                </li>
            </ul>
        </div>
        <div class="btn_btm">
    ...
    <div class="m_cont" id="ta3" style="display:none">
        <div class="m_ila_board">
            <ul class="lst_mov">
                <li>
                    <a href="s3_1_1.html">
                        <span class="thmb"><img src="/assets/images/mobile/@thmb.jpg" alt=""></span>
                        <span class="tit">생명의 우물파기 6편 1부 - 인터뷰인터뷰인터뷰인터뷰인터뷰</span>
                        <span class="desc">아뜨리버 잼슬럼가 어린이에게 먹을 것을아뜨리버 잼슬럼가 어린이에게 먹을 것을아뜨리버 잼슬럼가 어린이에게 먹을 것을</span>
                    </a>
                </li>
                <li>
                    <a href="s3_1_1.html">
                        <span class="thmb"><img src="/assets/images/mobile/@thmb.jpg" alt=""></span>
                        <span class="tit">생명의 우물파기 6편 1부 - 인터뷰</span>
                        <span class="desc">아뜨리버 잼슬럼가 어린이에게 먹을 것을</span>
                    </a>
                </li>
                <li>
                    <a href="s3_1_1.html">
            ...
            <div class="pagenate">
                <a href="#" class="prev2"><span class="blind">처음으로</span></a>
                <a href="#" class="prev"><span class="blind">이전</span></a>
                <strong title="현재 페이지">1</strong>
                <a href="#">2</a>
                <a href="#">3</a>
                <a href="#" class="next"><span class="blind">다음</span></a>
                <a href="#" class="next2"><span class="blind">끝으로</span></a>
            </div>
        </div>
