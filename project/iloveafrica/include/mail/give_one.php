...
<td style=\"border:1px solid #c4c4c4; width:537px;\">
    ...
    <td>
        <table cellpadding=\"0\" cellspacing=\"0\" border=\"0\">
        <tr>
        <td style=\"color:#494949; font-size:15px; font-weight:bold; padding:50px 20px 20px 20px;\">일시후원 결제안내</td>
        </tr>
        <tr>
        <td style=\"padding:20px 40px 10px 40px; border-top:2px solid #454545; color:#494949; font-size:12px;\">회원님께서 신청하신 일시후원이 정상적으로 결제 되었습니다.</td>
        </tr>
        <tr>
...
$_mail_title = "[I LOVE AFRICA] {{USER_NAME}} 님! 일시후원에 참여해 주셔서 감사합니다.";
