...
(function () {
  ...
  const tooltip = {
    ...
    createOmniListPopup: function () {
      ...
      const navOmni = _omni ? `<div class="pt_nav_btn pt_omni">
                    <p>OMNI</p>
                </div>` : '';
      const bodyOmni = _omni ? `<div class="pt_body_box pt_omni">
                    <ul class="pt_omni_list"></ul>
                    <div class="pt_modal_alert">
                        <div class="pt_alert_inner"></div>
                    </div>
                </div>` : '';
      const navImg = _img ? `<div class="pt_nav_btn pt_img">
                    <p>IMG</p>
                </div>` : '';
      const bodyImg = _img ? `<div class="pt_body_box pt_img">
                    <ul class="pt_img_list"></ul>
                    <div class="pt_modal_alert">
                        <div class="pt_alert_inner"></div>
                    </div>
                </div>` : '';
      const navTitle = _title ? `<div class="pt_nav_btn pt_title">
                    <p>TITLE</p>
                </div>` : '';
      const bodyTitle = _title ? `<div class="pt_body_box pt_title">
    ...
    createTooltip: function () {
      ...
      $secWrap.on('mouseover focus click', 'a', function (e) {
        ...
        }).html(omni === '' || omni === undefined || title === '' || title === undefined ? '해당 값이 없음' : omni).show();
      });
    },
