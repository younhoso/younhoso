                ...
                $category.each(function(index,el){
                    ...
                    if (parenstName.hasClass('pt_comp_cate'+ index)) {
                        ...
                        if(_scrollTop < _parenstScrollTop){
                            $('html, body').stop().animate({scrollTop:compTarget.offset().top - $this.find('.pt_slider_category_wrap').outerHeight() - _.pxToVw(40,40) / 1.01}, 500, function(){
                                $(compTarget).focusout(function(){
                                    $(compTarget).removeAttr('tabindex');
                                });
                            });
                        }else{
                            $('html, body').stop().animate({scrollTop:compTarget.offset().top - $this.find('.pt_slider_category_wrap').outerHeight() - _.pxToVw(40,40) / 1.01}, 1, function(){
                                $(compTarget).focusout(function(){
                                    $(compTarget).removeAttr('tabindex');
                                });
                            });
