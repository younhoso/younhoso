...
interface ContentAppBoardNoticeListCondition {
  perPage: string;
  checkList: string[];
}

export default function ContentAppBoardNoticeList() {
  const [selectedValue, setSelectedValue] = useState<ContentAppBoardNoticeListCondition>({
    perPage: 'all',
    checkList: [],
  });

  const handleValueChange = (key: keyof ContentAppBoardNoticeListCondition, value: any) => {
