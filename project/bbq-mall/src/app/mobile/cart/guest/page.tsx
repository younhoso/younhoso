...
import { MobileCartGuestPageStyled } from '@/styles/pageStyled/mobile/mobileCartGuestPageStyled';
...
const MobileCartGuest = () => {
  ...
  const { mutateAsync } = useMutation({
    mutationFn: (localCart: CartLocastorage[] | CartProductData[]) =>
      customAxios(PLATFORMLIST.MOBILE_WEB).post<Cart>('/guest/cart', localCart, {
        params: {
  ...
  const { mutateAsync: pricaeMutate } = useMutation({
    mutationFn: (localCart: CartLocastorage[] | CartProductData[]) =>
      customAxios(PLATFORMLIST.MOBILE_WEB).post<Cart & CartPrice>('/guest/cart', localCart, {
        params: {
          divideInvalidProducts: false,
        },
      }),
...
export default MobileCartGuest;
