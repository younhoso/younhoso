...
import { MemberChangePasswordWithCIPageTemplateComponentProps } from './MemberChangePasswordWithCIPageTemplate';

export const MemberChangePasswordWithCIPageTemplateMobile: FC<
  MemberChangePasswordWithCIPageTemplateComponentProps
> = ({
  token,
  integration,
  name,
