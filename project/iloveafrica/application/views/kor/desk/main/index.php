...
<div id="pop<?=$pop_no?>" style="display:none;z-index:2" >
	<div>
...
<div id="container">
		...
		<div class="main_campaign">
			...
			<div class="campaign_area">
				<a href="/index.php/project/well">
					<div class="bnr bnr_full">
						<span class="thmb"><img src="/assets/images/desk/pc_wellbanner.jpg" alt=""></span>
						<!--<a class="wellBtn" href="/index.php/project/well"></a>-->
					</div>
				</a>
				

				<div class="bnr bnr_full bnr_new">
					<div class="tit">여기 따끈따끈한 소식이 있어요</div>
					<div class="lst_thmb">
						<? foreach( $relief as $r ) { ?>
						<a href="/index.php/news/reliefview?idx=<?= $r["am_no"] ?>">
							<div class="tm"><img src="/pds/relief/<?= $r["am_image"] ?>" alt=""></div>
							<div class="cont">
								<div class="tx"><?= $r["am_title"] ?></div>
								<div class="cc"><?
									$cont = $r["am_content"];
									$cont = strip_tags($cont);
									$clen = mb_strlen($cont, "utf-8");
									$cnt = 120;
									if( $clen > $cnt ) {
										$cont = mb_substr($cont, 0, $cnt, "utf-8")."...";
									}
									echo $cont;
								?></div>
							</div>
				...
				<div class="bnr bnr_b">
					...
					<span class="tt">식수를 공급하는 우물파기는<br>아프리카의 사람들의 생명을 살려줍니다.</span>
		...
		<div class="main_mid_bnr">
			<div class="b1" style="background:url(/assets/images/desk/img_mid_bnr1.jpg) #FFAE00 100% 0 no-repeat">
				<div class="w">
					...
					<a href="/index.php/news/relief" class="link">구호활동 보기</a>
				</div>
			</div>
