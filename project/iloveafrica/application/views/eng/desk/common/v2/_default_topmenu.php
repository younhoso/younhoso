<div id="header">
    <div class="header_top">
        <div class="header_top_in">
            <h1 class="logo_header"><a href="/index.php/eng"><img src="/assets/images/desk/logo_header.png" alt="NGO I LOVE AFRICA"></a></h1>
            <div class="link">
    ...
    <div class="header_gnb">
        <div class="header_gnb_in">
            <ul class="nav" id="nav">
            <li class="t1">
                    <a href="/index.php/<?= $nationlink ?>foundation/about" class="d1"><span class="s">최초의 아프리카 전문 NGO</span>(영문)아이러브아프리카</a>
                    <ul class="nav_sub">
                ...
                <li class="t2">
                    <a href="/index.php/<?= $nationlink ?>business" class="d1">(영문)사업소개</a>
                    <ul class="nav_sub">
                ...
                <li class="t3">
                    <a href="/index.php/<?= $nationlink ?>news/report" class="d1">(ENG)ILA소식</a>
                    <ul class="nav_sub">
                ...
                <li class="t4">
                    <a href="/index.php/news/relief" class="d1">(ENG)구호활동보기</a>
                    <ul class="nav_sub">
                ...
                <li class="t5">
                    <a href="/index.php/<?= $nationlink ?>support/regular" class="d1">(ENG)후원하기</a>
                    <ul class="nav_sub">
