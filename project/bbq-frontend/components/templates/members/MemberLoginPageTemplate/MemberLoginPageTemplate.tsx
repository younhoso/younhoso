...
import { COLOR_GRAY, FONTSIZE_12, FONTSIZE_14, FONTSIZE_20 } from '@/constants';

import { Footer, TabBox, Wrapper } from '../components';
import { MemberLoginPageTemplateMobile } from './mobile';

export interface MemberLoginPageTemplateProps {
  id: string;
  ...
  login: () => void;
  snsLogin: (type: string) => void;
}

export interface MemberLoginPageTemplateComponentProps extends MemberLoginPageTemplateProps {}

export const MemberLoginPageTemplate: FC<MemberLoginPageTemplateComponentProps> & {
  Mobile: FC<MemberLoginPageTemplateComponentProps>;
} = ({ id, setId, password, setPassword, rememberMe, setRememberMe, login, snsLogin, ...rest }) => {
  return (
    <Wrapper>
      <Container>
        <Container.Body>
...
MemberLoginPageTemplate.Mobile = MemberLoginPageTemplateMobile;
