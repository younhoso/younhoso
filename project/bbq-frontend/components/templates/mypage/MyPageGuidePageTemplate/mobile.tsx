...
import { FONTSIZE_13, FONTSIZE_15 } from '@/constants';

import { Template } from '../components';
import { MyPageGuidePageTemplateComponentProps } from './MyPageGuidePageTemplate';

export const MyPageGuidePageTemplateMobile: FC<MyPageGuidePageTemplateComponentProps> = ({}) => {
  return (
    <Template.Mobile title="이용안내">
      <Text size={FONTSIZE_15}>배달/포장 주문</Text>
      <Space.H3 />
      <Text size={FONTSIZE_13} color={'#777777'} lineHeight={'1.5em'}>
        ➀ 여러분의 위치 정보를 확인해요.
        <br />
      ...
      <Space.H6 />
      <Text size={FONTSIZE_15}>쿠폰 사용</Text>
      <Space.H3 />
      <Text size={FONTSIZE_13} color={'#777777'} lineHeight={'1.5em'}>
      ...
      <Space.H6 />
      <Text size={FONTSIZE_15}>멤버십 혜택</Text>
      <Space.H3 />
      <Text size={FONTSIZE_13} color={'#777777'} lineHeight={'1.5em'}>
      ...
      <Space.H6 />
      <Text size={FONTSIZE_15}>유의사항</Text>
      <Space.H3 />
      <Text size={FONTSIZE_13} color={'#777777'} lineHeight={'1.5em'}>
