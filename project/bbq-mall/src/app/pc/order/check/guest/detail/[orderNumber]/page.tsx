...
import { PcOrderCheckGuestDetailPageStyled } from '@/styles/pageStyled/pc/pcOrderCheckGuestDetailPageStyled';
...
const PcOrderCheckGuestDetail = ({
  ...
  const { data, error, isPending, refetch } = useQuery({
    ...
    queryFn: () =>
      customAxios(PLATFORMLIST.PC).get<OrderHistoryDetail>(`/guest/orders/${orderNumber}`, {
        headers: { guestToken },
      }),
  });
  ...
  return (
    <PcOrderCheckGuestDetailPageStyled>
      <OrderDetail data={data?.data} isPending={isPending} refetch={refetch} />
    </PcOrderCheckGuestDetailPageStyled>
  );
};

export default PcOrderCheckGuestDetail;
