...
import { COLOR_BLACK, COLOR_RED, FONTSIZE_13, PLANCK } from '@/constants';
      ...
      <Grid columnCount={1} gap={PLANCK * 1.5}>
        {[
          ...
          return (
            ...
            >
              <Space.V2_5 />
              <Text size={FONTSIZE_13} color={item.count ? COLOR_BLACK : 'rgba(0,0,0,0.3)'}>
              ...
              {(() => {
                ...
                if (item.type === 'boolean' && (item.appliedCount ?? 0) > 0) {
                  return (
                    <Text size={FONTSIZE_13} color={COLOR_RED}>
                      쿠폰 적용 완료
                    </Text>
                  );
