    ...
    init(){
        ...
        let scrollMove = function() {
            ...
            $category.each(function(index,el){
                ...
                // 컴포넌트 카테고리 sticky 처리
                if (cateSticky[index] != 'false' && _scrollTop >= $this.find('.pt_slider_category_sticky').offset().top && _scrollTop <= cateEnd[index].offset().top + cateEnd[index].outerHeight() - $this.outerHeight() - _.pxToVw(90, 90)) {
