...
import { MemberJoinNewWithCIPageTemplateMobile } from './mobile';

export interface MemberJoinNewWithCIPageTemplateProps {
  username: string;
...
export interface MemberJoinNewWithCIPageTemplateComponentProps
  extends MemberJoinNewWithCIPageTemplateProps {}

export const MemberJoinNewWithCIPageTemplate: FC<MemberJoinNewWithCIPageTemplateComponentProps> & {
  Mobile: FC<MemberJoinNewWithCIPageTemplateComponentProps>;
} = ({
  username,
  setUsername,
...
MemberJoinNewWithCIPageTemplate.Mobile = MemberJoinNewWithCIPageTemplateMobile;
