...
interface ContentAppBoardEventWriteCondition {
  category: string;
  categoryAdd: string;
  title: string;
  content: string;
...
export default function ContentAppBoardFaqWrite() {
  const [selectedValue, setSelectedValue] = useState<ContentAppBoardEventWriteCondition>({
    category: '',
    categoryAdd: '',
    title: '',
    content: '',
  ...
  const handleValueChange = (key: keyof ContentAppBoardEventWriteCondition, value: any) => {
