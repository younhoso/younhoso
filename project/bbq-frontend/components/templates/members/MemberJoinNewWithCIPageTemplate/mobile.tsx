...
import { MemberJoinNewWithCIPageTemplateComponentProps } from './MemberJoinNewWithCIPageTemplate';

export const MemberJoinNewWithCIPageTemplateMobile: FC<
  MemberJoinNewWithCIPageTemplateComponentProps
> = ({
  username,
  setUsername,
