                ...
                $category.each(function(index,el){
                    ...
                    if (parenstName.hasClass('pt_comp_cate'+ index)) {
                        ...
                        if(_scrollTop < _parenstScrollTop){
                            $('html, body').stop().animate({scrollTop:compTarget.offset().top - $this.find('.pt_slider_category_wrap').outerHeight() / 1.01- _.pxToVw(60, 204)}, 500, function(){
                                $(compTarget).focusout(function(){
                                    $(compTarget).removeAttr('tabindex');
                                });
                            });
                        }else{
                            $('html, body').stop().animate({scrollTop:compTarget.offset().top - $this.find('.pt_slider_category_wrap').outerHeight() / 1.01- _.pxToVw(60, 204)}, 1, function(){
                                $(compTarget).focusout(function(){
                                    $(compTarget).removeAttr('tabindex');
                                });
                            });
