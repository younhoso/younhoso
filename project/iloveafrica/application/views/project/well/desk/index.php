...
<title>ILOVEAFRICA PROJECT</title>
<link rel="stylesheet" type="text/css" href="/assets/css/desk/common.css" />
<link rel="stylesheet" type="text/css" href="/assets/css/desk/well.css?v=1" />
<script type="text/javascript" src="/assets/js/jquery-3.2.1.min.js"></script>
</head>
<body>
<div id="wrap">
	<a href="<?php echo SUPPORT_WATER_URL; ?>" target="<?php echo SUPPORT_WATER_TARGET; ?>" class="dd_fix hvr-float-shadow"><span class="blind">우물 파기 참여하기</span></a>
	<div class="module sec1">
		<img src="/assets/images/desk/well/bg1.jpg" alt="웅덩이 물 먹음">
		<div class="inner">
			<!-- <div class="bi"><span class="blind">ILOVEAFRICA PROJECT</span></div> -->
			<!--<div class="txt"><span class="blind">아프리카 우물! 2만개 파기! 릴레이 운동</span></div>-->
		</div>
	</div>
	<div class="module sec2">
		<img src="/assets/images/desk/well/bg2.jpg" alt="웅덩이 물 먹음">
		<div class="inner">
			<div class="txt"><span class="blind">여러분이 파주신 우물로 아프리카 아이들의 생명을 살렸습니다. </span></div>
		</div>
	</div>
	<div class="module sec3">
		<div class="inner">
			<div class="txt"><span class="blind">여러분이 건립한 아프리카 생명의 우물입니다.</span></div>
			<div class="txt2">
				<p class="tt font_tans">식수를 공급하는 우물파기는 아프리카 사람들의 생명을 살려줍니다.</p>
				<p>아이러브아프리카는 지도에도 표시되지 않는 지역에서 소중한 활동을 이어가고 있어, <br> 후원자들과 일반인들에게는 생생한 현장 사진을 통해 소통하고 있어요. </p>
				<!-- <span class="blind">아이러브아프리카 우물 사이트가 리뉴얼 중입니다.</span> -->
			</div>
			<div class="bx1">
				<div class="scr">
					<ul id="mapSet">
					<?php
						$wells = array(
							93 => array(
								"title" => "76호 태양광 설치 우물 - 2023년 완공 - 깊이 약 250m 시추, 솔라 시스템 우물 - 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
							...
							92 => array(
								"title" => "75호 태양광 설치 우물 - 2021년~2022년 완공 - 깊이 약 280m 시추, 솔라 시스템 우물 - 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
							...
							// ),
							90 => array(
								"title" => "74호 우물 - 2020년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
							...
							89 => array(
								"title" => "73호 우물 - 2020년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							88 => array(
								"title" => "72호 우물 - 2020년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							87 => array(
								"title" => "71호 우물 - 2020년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							86 => array(
								"title" => "70호 우물 - 2020년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							85 => array(
								"title" => "69호 우물 - 2020년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							84 => array(
								"title" => "68호 우물 - 2020년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							83 => array(
								"title" => "67호 우물 - 2020년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							82 => array(
								"title" => "66호 우물 - 2020년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							81 => array(
								"title" => "65호 우물 - 2020년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							80 => array(
								"title" => "64호 우물 - 2020년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							79 => array(
								"title" => "63호 우물 - 2020년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							78 => array(
								"title" => "62호 우물 - 2020년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							77 => array(
								"title" => "61호 우물 - 2020년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							76 => array(
								"title" => "60호 우물 - 2020년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							75 => array(
								"title" => "59호 우물 - 2020년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							74 => array(
								"title" => "58호 우물 - 2019년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							73 => array(
								"title" => "57호 우물 - 2019년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							72 => array(
								"title" => "56호 우물 - 2019년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							71 => array(
								"title" => "55호 우물 - 2019년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
							...
							70 => array(
								"title" => "54호 우물 - 2019년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							69 => array(
								"title" => "53호 컨테이너형 초대형 정수시설 설치 - 2015년 환경부 MOU 사업 - 탄자니아 지역 주민 20,000여명에게 식수 공급",
							...
							// ),
							64 => array(
								"title" => "52호 저수지 - 2018년 개발 - 원주민의 생명수 - 타워. 물저장탱크, 원주민 음용 물파이프, 가축의 구유 설치",
								"addr2" => "KENYA, NORETER",
							...
							63 => array(
								"title" => "52호 저수지 - 2018년 개발 - 가축의 생명수 - 타워. 물저장탱크, 원주민 음용 물파이프, 가축의 구유 설치",
								"addr2" => "KENYA, NORETER",
								"addr1" => "카지아도 노레텟 마사이부족 지역",
								"spon" => "전현구, 김진미 부부",
							...
							// ),
							59 => array(
								"title" => "51호 저수지 - 2017년 개발 - 저수지 이정표 세우기 - 타워. 물저장탱크, 식수공급 파이프, 가축의 구유 설치",
							...
							58 => array(
								"title" => "51호 저수지- 2017년 개발 - 마사이 원주민의 가축은 재산목록 1호 - 타워. 물저장탱크, 식수공급 파이프, 가축의 구유 설치",
								"addr2" => "KENYA, LENGKIESHON",
								"addr1" => "카지아도 랭키숀 마사이부족 지역",
								"spon" => "장영란 권사, 권춘자 권사",
								"bene" => "원주민 6,500여 명, 가축 5,500여 마리",
							...
							57 => array(
								"title" => "51호 저수지 - 2017년 개발 - 물 먹는 마사이 원주민 - 타워. 물저장탱크, 식수공급 파이프, 가축의 구유 설치",
								"addr2" => "KENYA, LENGKIESHON",
								"addr1" => "카지아도 랭키숀 마사이부족 지역",
								"spon" => "장영란 권사, 권춘자 권사",
								"bene" => "원주민 6,500여 명, 가축 5,500여 마리",
							...
							56 => array(
								"title" => "51호 저수지 - 2017년 개발 - 2차 방문 완공식 - 원주민과 가축의 음용 - 타워. 물저장탱크, 식수공급 파이프, 가축의 구유 설치",
								"addr2" => "KENYA, LENGKIESHON",
								"addr1" => "카지아도 랭키숀 마사이부족 지역",
								"spon" => "장영란 권사, 권춘자 권사",
								"bene" => "원주민 6,500여 명, 가축 5,500여 마리",
							...
							55 => array(
								"title" => "51호 저수지 - 2017년 개발 - 1차 방문점검 - 원주민과 가축의 음용 - 타워. 물저장탱크, 식수공급 파이프, 가축의 구유 설치",
								"addr2" => "KENYA, LENGKIESHON",
								"addr1" => "카지아도 랭키숀 마사이부족 지역",
								"spon" => "장영란 권사, 권춘자 권사",
								"bene" => "원주민 6,500여 명, 가축 5,500여 마리",
							...
							54 => array(
								"title" => "50호 저수지 - 2017년 물받는 원주민과 물먹는 가축 - 타워. 물저장탱크, 식수공급 파이프, 가축의 구유 설치",
							...
							53 => array(
								"title" => "50호 저수지 - 2017년 완공식 - 원주민과 가축의 음용 - 타워. 물저장탱크, 식수공급 파이프, 가축의 구유 설치",
								"addr2" => "KENYA, KAJIADO ILLUANAT",
								"addr1" => "카지아도 일루아나트 마사이부족 지역",
								"spon" => "전라남도 강진군",
								"bene" => "원주민 5,000여 명, 가축 3,500여 마리",
							...
							52 => array(
								"title" => "50호 저수지 - 2017년 공사과정 - 원주민과 가축의 음용 - 타워. 물저장탱크, 식수공급 파이프, 가축의 구유 설치",
								"addr2" => "KENYA, KAJIADO ILLUANAT",
								"addr1" => "카지아도 일루아나트 마사이부족 지역",
								"spon" => "전라남도 강진군",
								"bene" => "원주민 5,000여 명, 가축 3,500여 마리",
							...
							51 => array(
								"title" => "49호 우물 - 2018년 완공 - 깊이 약 100m~194m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, KILWA County",
							...
							50 => array(
								"title" => "48호 우물 - 2018년 완공 - 깊이 약 100m~193m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, KILWA County",
							...
							49 => array(
								"title" => "47호 우물 - 2018년 완공 - 깊이 약 100m~192m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, KILWA County",
							...
							48 => array(
								"title" => "46호 우물 - 2018년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, KILWA County",
							...
							47 => array(
								"title" => "45호 우물 - 2015년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							46 => array(
								"title" => "44호 우물 - 2015년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
							...
							45 => array(
								"title" => "43호 우물 - 2015년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
							...
							44 => array(
								"title" => "42호 우물 - 2015년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 식수저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, KINONDONI County",
							...
							// ),
							42 => array(
								"title" => "40호 우물을 초등학교 화장실 옆에  연결하여 물을 공급하는 시스템 - 타워, 물저장탱크, 수도칸, 수도꼭지 설치 초등학교 화장실 개선사업",
								"addr2" => "TANZANIA, KINONDONI County",
							...
							41 => array(
								"title" => "40호 우물 - 2014년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, KINONDONI County",
								"addr1" => "카와와 KAWAWA P/School",
								"spon" => "KE 한국수출입은행",
								"bene" => "학생 7,500여 명, 주민 2,200여 명",
							...
							40 => array(
								"title" => "39호 우물을 초등학교 화장실 옆에  연결하여 물을 공급하는 시스템 - 타워, 물저장탱크, 수도칸, 수도꼭지 설치 초등학교 화장실 개선사업",
								"addr2" => "TANZANIA, KINONDONI County",
							...
							39 => array(
								"title" => "39호 우물 - 2014년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, KINONDONI County",
								"addr1" => "음파카니 MPAKANI P/School",
								"spon" => "KE 한국수출입은행",
								"bene" => "학생 6,000여 명, 주민 2,000여 명",
							...
							38 => array(
								"title" => "38호 우물을 초등학교 화장실 옆에  연결하여 물을 공급하는 시스템 - 타워, 물저장탱크, 수도칸, 수도꼭지 설치 초등학교 화장실 개선사업",
								"addr2" => "TANZANIA, KINONDONI County",
							...
							37 => array(
								"title" => "38호 우물 - 2014년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, KINONDONI County",
								"addr1" => "마비보 MABIBO P/School",
								"spon" => "KE 한국수출입은행",
								"bene" => "학생 3,500여 명, 주민 2,100여 명",
							...
							36 => array(
								"title" => "37호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, TEMEKE County",
							...
							35 => array(
								"title" => "36호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, TEMEKE County",
							...
							34 => array(
								"title" => "35호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							33 => array(
								"title" => "34호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							32 => array(
								"title" => "33호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, TEMEKE County",
							...
							31 => array(
								"title" => "32호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							30 => array(
								"title" => "31호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, TEMEKE County",
							...
							29 => array(
								"title" => "30호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, TEMEKE County",
							...
							28 => array(
								"title" => "29호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, TEMEKE County",
							...
							27 => array(
								"title" => "28호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, KINONDONI County",
							...
							26 => array(
								"title" => "27호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, KINONDONI County",
							...
							25 => array(
								"title" => "26호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, KINONDONI County",
							...
							24 => array(
								"title" => "25호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, TEMEKE County",
							...
							23 => array(
								"title" => "24호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
							...
							22 => array(
								"title" => "23호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, TEMEKE County",
							...
							21 => array(
								"title" => "22호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, DAR SALAAM City",
							...
							20 => array(
								"title" => "21호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, DAR SALAAM City",
							...
							19 => array(
								"title" => "20호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, DAR SALAAM City",
							...
							18 => array(
								"title" => "19호 우물 - 2013년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, DAR SALAAM City",
							...
							17 => array(
								"title" => "18호 우물 - 2012년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							16 => array(
								"title" => "17호 우물 - 2012년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
							...
							15 => array(
								"title" => "16호 우물 - 2012년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, KINONDONI County",
							...
							14 => array(
								"title" => "15호 우물 - 2012년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, KINONDONI County",
							...
							13 => array(
								"title" => "14호 우물 - 2012년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, DAR SALAAM City",
							...
							12 => array(
								"title" => "13호 우물 - 2012년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
							...
							11 => array(
								"title" => "12호 우물 - 2012년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, DAR SALAAM City",
							...
							10 => array(
								"title" => "11호 우물 - 2012년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, DAR SALAAM City",
							...
							9 => array(
								"title" => "10호 우물 - 2012년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, DAR SALAAM City",
							...
							8 => array(
								"title" => "9호 우물 - 2012년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, KINONDONI County",
								"addr1" => "신자 장애인 특수학교",
							...
							7 => array(
								"title" => "8호 우물 - 2012년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
							...
							6 => array(
								"title" => "7호 우물 - 2012년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
							...
							5 => array(
								"title" => "6호 우물 - 2012년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, BAGAMOYO County",
							...
							4 => array(
								"title" => "5호 우물 - 2012년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							3 => array(
								"title" => "4호 우물 - 2012년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							2 => array(
								"title" => "3호 우물 - 2012년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, MKURANGA County",
							...
							1 => array(
								"title" => "2호 우물 - 2012년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, KINONDONI County",
							...
							0 => array(
								"title" => "1호 우물 - 2012년 완공 - 깊이 약 100m~150m 개발 수중펌프설치, 지상 제너레이터, 타워, 물저장탱크, 수도칸, 수도꼭지 설치",
								"addr2" => "TANZANIA, KINONDONI County",
					...
					?>
						<li class="<? echo $num == 1 ? 'on' : ''?>"><a href="#" 
							...
							data-bene="<?=$v["bene"]?>" 
							data-map="<?=$v["map"]?>" 
							data-map-tit="<?=$v["map_tit"]?>"
							data-imgs="<?=$v["imgs"]?>"
							class="ty<?=$ty?>"><em><?=$v["num"]?></em></a></li>
					<?
						}
					?>
					<?php
					...
					?>
						<li class="forced">
							<a href="#"><img src="/assets/images/desk/group24.png" alt="지구아이콘"></a>
						</li>
					<?php
					}
					?>
			...
			<div class="bx2">
				<div class="map_top">
					<div class="tit" id="wellTit"><?=$selected['title']?></div>
					<div class="desc">
						<dl>
							<dt>국가/카운티</dt>
							<dd id="wellAddr1"><?=$selected['addr2']?></dd>
						</dl>
						<dl>
							<dt>건립지역</dt>
							<dd id="wellAddr2"><?=$selected['addr1']?></dd>
						</dl>
						<dl>
							<dt>후원자</dt>
							<dd id="wellSpon"><?=$selected['spon']?></dd>
						</dl>
						<dl>
							<dt>수혜인원</dt>
							<dd id="wellBene"><?=$selected['bene']?></dd>
						</dl>
					</div>
					<div class="map_cont">
						<iframe src="<?=$selected['map']?>" width="1200" height="400" frameborder="0" style="border:0" allowfullscreen id="wellMap"></iframe>
						<div class="dd">
							<p>구글 지도로 내려다 본</p>
							<strong id="wellMapTit"><?=$selected['map_tit']?></strong>
						</div>
					</div>
					<div class="map_thmb">
						<ul id="mapImgList">
							<?php 
								if(!empty($selected['imgs'])) {
									$images = explode(',', $selected['imgs']);
	...
	<div class="module sec4">
		<div class="inner">
			<ul class="well_slider">
				<li><img src="/assets/images/desk/well/thmb/thmb_s1.jpg" alt=""></li>
				<li><img src="/assets/images/desk/well/thmb/thmb_s2.jpg" alt=""></li>
				<li><img src="/assets/images/desk/well/thmb/thmb_s3.jpg" alt=""></li>
				<li><img src="/assets/images/desk/well/thmb/thmb_s4.jpg" alt=""></li>
				<li><img src="/assets/images/desk/well/thmb/thmb_s5.jpg" alt=""></li>
				<li><img src="/assets/images/desk/well/thmb/thmb_s6.jpg" alt=""></li>
				<li><img src="/assets/images/desk/well/thmb/thmb_s7.jpg" alt=""></li>
				<li><img src="/assets/images/desk/well/thmb/thmb_s8.jpg" alt=""></li>
				<li><img src="/assets/images/desk/well/thmb/thmb_s9.jpg" alt=""></li>
				<li><img src="/assets/images/desk/well/thmb/thmb_s10.jpg" alt=""></li>
			</ul>
			<div class="txt">
				물은 생명입니다. 우물을 파 주셔서 <br> 생명을 살려주세요 !!♡
			</div>
			<div class="stit1">
				<img src="/assets/images/desk/well/tit_s1.png" alt="오염된 물로 사망하는 아이들 525,500명" />
			</div>
			<div class="stit2">
				<img src="/assets/images/desk/well/tit_s2.png" alt="아이러브아프리카가 건립한 생명의 우물 수 49개" />
			</div>
			<div class="stit3">
				<img src="/assets/images/desk/well/tit_s3.png" alt="깨끗한 물을 마시게 된 아프리카 사람들의 수 1,000,000명" />
			</div>
		</div>
	</div>
	<div class="module sec5">
		<div class="inner">
			<div class="tit"><span class="blind">현장소식과 이야기가 궁금하세요?</span></div>
			<ul class="lst_vods"><?php
				for($i = 0, $len = count($result) ; $i < $len ; $i++) {
					$item = $result[$i];
					?><li>
						<a href="<?= $viewpath ?>&idx=<?= $item["am_no"]?>">
							<span class="thmb"><img src="/pds/relief/<?php echo $item["am_image"]; ?>" alt="<?= $item["am_title"] ?>"></span>
							<div class="cont">
								<span class="desc"><?= $item["am_title"] ?></span>
							</div>
						</a>
					</li><?php 
				}
	...
	<div class="module sec6">
		<div class="inner">
			<div class="s_togather">
				<div class="s_tit"><span>ILOVEAFRICA</span> PROJECT</div>
				<div class="h_tit">아프리카 우물! 2만개 파기!  <br>릴레이 운동</div>
				<p class="desc">깨끗한 물은 아프리카 사람들의 생명, 희망, 미래입니다.<br />그들이 건강한 삶을 살 수 있도록 <br />후원자님의 많은 관심과 사랑 부탁드립니다.</p>
				<a href="<?php echo SUPPORT_WATER_URL; ?>" target="<?php echo SUPPORT_WATER_TARGET; ?>" class="link hvr-float-shadow">후원하기</a>
			</div>
		</div>
	</div>
	<div class="module sec7">
		<div class="inner">
			<a href="/"><div class="logo"></div></a>
			<div class="txt">저작권자 &copy; 아이러브아프리카, 무단 전재-재배포를 금합니다.</div>
		</div>
	</div>
</div>
...
$('#mapSet').on('click','li > a',function(e){
	e.preventDefault();
	var _this = $(this),
	vTit = _this.data('tit'),
	vAddr2 = _this.data('addr2'),
	vAddr1 = _this.data('addr1'),
	vSpon = _this.data('spon'),
	vBene = _this.data('bene'),
	vMap = _this.data('map'),
	vMapTit = _this.data('mapTit'),
	vImgs = _this.data('imgs'),
	aImgs = vImgs.split(','),
	elImg='';
	...
	if (aImgs != ''){
		for(var i = 0 ; i < aImgs.length ; i++){
			elImg += '<li><img src="'+aImgs[i]+'"></li>';
		}
	}
	

	$('#wellTit').text(vTit);
	$('#wellAddr1').text(vAddr1);
	$('#wellAddr2').text(vAddr2);
	$('#wellSpon').text(vSpon);
	$('#wellBene').html(vBene);
	$('#wellMap').attr('src',vMap);
	$('#wellMapTit').html(vMapTit);
	$('#mapImgList').html(elImg)
});
