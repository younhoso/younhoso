...
<table cellpadding="0" cellspacing="0" border="0" class="sub03_table" id="tab203" >
  <tr>
    <td class="sub_title">외환계좌안내</td>
  </tr>
  <tr>
...
<tr>
<td style="width:348px; height:50px; padding:5px; border-color:#CCC; border-right-style:dotted; border-top-style:dotted; font-size:14px;"><center><a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=ZBMWV2WSL2MQY" target="_blank"/><img src="img/btn_donate.gif" /></a>
</center></td>
<td style="width:348px; height:50px; padding:5px; border-color:#CCC; border-left-style:dotted; border-top-style:dotted; font-size:14px;"><center><img src="img/account.png" href="#" onclick="window.open('/foreign_exchange_account.html', 'window', 'width=750, height=900')" />
</center></td>
</tr></table>
<br />
