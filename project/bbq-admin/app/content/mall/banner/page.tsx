...
interface ContentMallBannerPageCondition {
...
export default function ContentMallBannerPage() {
  const [selectedValue, setSelectedValue] = useState<ContentMallBannerPageCondition>({
    appBannerFile: [],
    pcBannerFile: [],
    bannerTitle: '',
    bannerUrl: '',
  ...
  const handleValueChange = (
    key: keyof ContentMallBannerPageCondition,
