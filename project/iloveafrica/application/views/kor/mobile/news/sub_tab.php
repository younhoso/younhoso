...
<div class="tab_d2">
    <ul id="t2">
        <!-- <li <?php if(subMenuCheck($uri, array("relief", "reliefview"))) { ?>class="on"<?php } ?>><a href="/index.php/<?= $nationlink ?>news/relief">구호활동</a></li> -->
        ...
        <li <?php if(subMenuCheck($uri, array("download"))) { ?>class="on"<?php } ?>><a href="/index.php/<?= $nationlink ?>news/download">특별자료실</a></li>
    </ul>
</div>