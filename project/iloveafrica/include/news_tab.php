	...
	if(count($_list) > 0){ // 리스트가 있을경우
		...
		for($i=0;$i<count($_list);$i++){
			...
			*/
			...
			$_list_link="board.php?m=m01&s=main&b_class=13&mode=VIEW_FORM&b_no=".$_list[$i]['b_no'];
...
<div class="ila_news" id="menu<?=$i+1?>" style="display:<?=$display?>;">
   <h1><img src="img/ila_news_title.png" alt="아프리카뉴스" /></h1>
    ...
    <div class="campaign_page">
        ...
        <span class="more"><a href="board.php?b_class=13"><img src="img/more.png" alt="more" /></a></span>
    </div>
