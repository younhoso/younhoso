...
import { MemberIntegrateCompletePageTemplateComponentProps } from './MemberIntegrateCompletePageTemplate';

export const MemberIntegrateCompletePageTemplateMobile: FC<
  MemberIntegrateCompletePageTemplateComponentProps
> = ({ ...rest }) => {
