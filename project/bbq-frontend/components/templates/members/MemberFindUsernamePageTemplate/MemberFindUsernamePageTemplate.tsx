...
import { MemberFindUsernamePageTemplateMobile } from './mobile';

export interface MemberFindUsernamePageTemplateProps {
  name: string;
...
export interface MemberFindUsernamePageTemplateComponentProps
  extends MemberFindUsernamePageTemplateProps {}

export const MemberFindUsernamePageTemplate: FC<MemberFindUsernamePageTemplateComponentProps> & {
  Mobile: FC<MemberFindUsernamePageTemplateComponentProps>;
} = ({
  name,
  setName,
  phoneNumber,
...
MemberFindUsernamePageTemplate.Mobile = MemberFindUsernamePageTemplateMobile;
