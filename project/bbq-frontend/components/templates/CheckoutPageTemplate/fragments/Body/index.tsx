...
import { COLOR_BLACK, COLOR_WHITE, FONTSIZE_20, PLANCK } from '@/constants';
...
const Body: FC<CheckoutPageTemplateProps> = props => {
  ...
  return (
    <Box padding={PLANCK * 6} border={'#dddddd'} background={'#f8f9fa'}>
      <Box>
        <Flex.CSS gap={PLANCK * 4}>
          <Box
            full
            thickness={2}
            border={COLOR_BLACK}
            background={COLOR_WHITE}
            padding={`0 ${PLANCK * 5}px`}
          >
            <Space.H3 />
            <Flex.RSC>
              <Icon
          ...
          <Box full border={'#dddddd'} background={COLOR_WHITE} padding={`0 ${PLANCK * 5}px`}>
            <Space.H3_5 />
            <Flex.RSC>
              <Icon src="pin-black-line.svg" size={24} />
              <Space.V2 />
              <Text size={FONTSIZE_20}>배송지 설정</Text>
            </Flex.RSC>
            <Space.H3_5 />
            <Divider />
            <Space.H3_5 />
          ...
          <Box full border={'#dddddd'} background={COLOR_WHITE} padding={`0 ${PLANCK * 5}px`}>
            <Space.H3_5 />
            <Flex.RSC>
              <Icon src="human-talking-black-line.svg" size={24} />
              <Space.V2 />
              <Text size={FONTSIZE_20}>주문 요청 사항</Text>
            </Flex.RSC>
            <Space.H3_5 />
            <Divider />
            <Space.H3_5 />
          ...
          <Box full border={'#dddddd'} background={COLOR_WHITE} padding={`0 ${PLANCK * 5}px`}>
            <Space.H3_5 />
            <Flex.RSC>
              <Icon src="basket-bbq-black.svg" size={24} />
              <Space.V2 />
              <Text size={FONTSIZE_20}>주문 상품</Text>
            </Flex.RSC>
            <Space.H3_5 />
            <Divider />
            <Space.H3_5 />
          ...
          <Box full border={'#dddddd'} background={COLOR_WHITE} padding={`0 ${PLANCK * 5}px`}>
            <Space.H3_5 />
            <Flex.RSC>
              <Icon src="double-ticket-black.svg" size={24} />
              <Space.V2 />
              <Text size={FONTSIZE_20}>할인쿠폰</Text>
            </Flex.RSC>
            <Space.H3_5 />
            <Divider />
            <Space.H3_5 />
          ...
          {member ? (
            <>
              <Box full border={'#dddddd'} background={COLOR_WHITE} padding={`0 ${PLANCK * 5}px`}>
                <Space.H3_5 />
                <Flex.RSC>
                  <Icon src="folded-point-black.svg" size={24} />
                  <Space.V2 />
                  <Text size={FONTSIZE_20}>포인트</Text>
                </Flex.RSC>
                <Space.H3_5 />
                <Divider />
                <Space.H3_5 />
            ...
            <>
              <Box full border={'#dddddd'} background={COLOR_WHITE} padding={`0 ${PLANCK * 5}px`}>
                ...
                <Flex.RSC>
                  <Icon src="folded-point-black.svg" size={24} />
                  <Space.V2 />
                  <Text size={FONTSIZE_20}>제휴포인트</Text>
                </Flex.RSC>
                <Space.H3_5 />
                <Divider />
                <Space.H3_5 />
          ...
          {props.totalPrice > 0 ? (
            <Box full border={'#dddddd'} background={COLOR_WHITE} padding={`0 ${PLANCK * 5}px`}>
              <Space.H3_5 />
              <Flex.RSC>
                <Icon src="card-with-hand-black-line.svg" size={24} />
                <Space.V2 />
                <Text size={FONTSIZE_20}>결제수단</Text>
              </Flex.RSC>
              <Space.H3_5 />
              <Divider />
              <Space.H3_5 />
