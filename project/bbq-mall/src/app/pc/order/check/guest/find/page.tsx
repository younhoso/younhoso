...
import { PcOrderCheckGuestFindPageStyled } from '@/styles/pageStyled/pc/pcOrderCheckGuestFindPageStyled';

const PcOrderCheckGuestFind = () => {
  ...
  return (
    <PcOrderCheckGuestFindPageStyled>
      <h2>주문 비밀번호 찾기</h2>
      <p>주문번호를 입력하시면</p>
      <p>
          ...
          try {
            ...
            await queryClient.fetchQuery({
              ...
              queryFn: ({ queryKey: [key] }) =>
                customAxios(PLATFORMLIST.PC).get(key, {
      ...
      >
        ...
        />
        <Button fullWidth styleType="main" disabled={isLoading} isLoading={isLoading}>
          확인
        </Button>
      </form>
    </PcOrderCheckGuestFindPageStyled>
...
export default PcOrderCheckGuestFind;
