...
<table cellpadding="0" cellspacing="0" border="0" class="sub03_table" id="tab301">
    <tr>
        <td class="sub_title">동호회후원</td>
    </tr>
    <tr>
        <td class="sub_c" valign="top" id="tab1">
			<table cellpadding="0" cellspacing="0" border="0" style="width:731px;">
                <tr>
                    <td class="p_b_32"><img src="img/sub03/dong1_o.png" onclick="f_tab(1);" class="cp" /><img src="img/sub03/dong2.png" onclick="f_tab(2);" class="cp" /><img src="img/sub03/dong3.png" onclick="f_tab(3);" class="cp" /></td>
                </tr>
                <tr>
                    <td class="p_b_28"><img src="img/sub03/s32231_1.png" /></td>
                </tr>
                <tr>
                    <td style="padding-bottom:30px; height:32px; border-bottom:1px solid #e5e5e5;"><div class="fl"><img src="img/sub03/s32231_2.png" /></div>
                        <div class="fr"><img src="img/sub03/s32231_3.png" onclick="f_tab(2);" class="cp"/></div></td>
                </tr>
                <tr>
                    <td style="padding-top:30px;  padding-bottom:60px;"><div class="fl"><img src="img/sub03/s32221_4.png" />
                            <p class="sub03_p">1. 활동하고 있는 동호회 및 클럽을 지정해 주세요.<br />
                                2. 후원금을 선정 해 주세요.<br />
                                3. 후원하게 된 계기와 사연을 작성 해 주세요.<br />
                                4. 10만 원 이상 후원 해 주신 동호회 및 클럽에는 <span style="color:#ff3232; font-size:13px; font-weight:bold;">※후원 증서</span>를 발송 해 드립니다.</p>
                        </div>
                        <div style="float:right; text-align:center; width:176px;"><img src="img/sub03/s32221_5.png" /><br />
                            <br />
                            <img src="img/sub03/s32221_6.png" onclick="javascript:layer_pop_view('certificate.php?chk=2','530')" class="cp"/></div></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="background:#f0f0f0; width:731px; height:98px;"><div style="float:left; padding-left:20px;"><img src="img/sub03/s32231_4.png" /></div>
...
<table cellpadding="0" cellspacing="0" border="0" class="sub03_table" id="tab302" >
    <tr>
        <td class="sub_title">동호회후원 신청</td>
    </tr>
    <tr>
        <td class="sub_c" valign="top" id="tab2">
<form name="fFrm" method="post" action="sub03_02_02_03_01_ok.php">
<input type="hidden" name="mode" value="INSERT_ACTION">
<input type="hidden" name="f_type" value="2">
			<table cellpadding="0" cellspacing="0" border="0" style="width:731px;">
                <tr>
                    <td class="p_b_32"><img src="img/sub03/dong1.png" onclick="f_tab(1);" class="cp" /><img src="img/sub03/dong2_o.png" onclick="f_tab(2);" class="cp" /><img src="img/sub03/dong3.png" onclick="f_tab(3);" class="cp" /></td>
                </tr>
                <tr>
                    <td class="p_b_28"><img src="img/sub03/s32231_1.png" /></td>
                </tr>
                ...
                <tr>
                    <td><table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td width="138" height="30" class="s32221_td1" style=" border-top:2px solid #454545;">동호회 이름</td>
                                <td width="594" height="30" class="s32221_td2" style=" border-top:2px solid #454545;"><input type="text" style="width:150px; height:18px; border:1px solid #cacaca;" name="f_name" class="{label:'팬클럽 이름',required:true}" /></td>
                            </tr>
                            <tr>
...
?>
                            ...
                            <tr>
                                ...
                                <td width="594" height="60" style="border-bottom:2px solid #454545;"><textarea name="f_memo" id="ai_memo3" style="width:594px;height:150px;"></textarea></td>
                            </tr>
                        </table></td>
                </tr>
                <tr>
...
<table cellpadding="0" cellspacing="0" border="0" class="sub03_table" id="tab303" >
    <tr>
        <td class="sub_title">동호회후원 후기</td>
    </tr>
    <tr>
        <td class="sub_c" valign="top">
		<table cellpadding="0" cellspacing="0" border="0" style="width:731px;">
                <tr>
                    <td class="p_b_32"><img src="img/sub03/dong1.png" onclick="f_tab(1);" class="cp" /><img src="img/sub03/dong2.png" onclick="f_tab(2);" class="cp" /><img src="img/sub03/dong3_o.png" onclick="f_tab(3);" class="cp" /></td>
                </tr>
                <tr>
                    <td class="p_b_28"><img src="img/sub03/s32231_5.png" /></td>
                </tr>
                <tr>
                    <td><ul>
<?
...
?>
                            <li class="sub03_li"><img src="<?=$thumbImage?>" class="img_b" width="170" height="123"/><br />
                                ...
                                <br />
                                <img src="img/sub03/s32221_17.png" onclick="javascript:layer_pop_view('fview1.php?f_no=<?=$_list[$i]["f_no"]?>','391')" class="cp"/><br />
                                <br />
                            </li>
<?
		}
